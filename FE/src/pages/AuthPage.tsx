  ...
  return (
    <div className="bg-slate-950 font-sans selection:bg-blue-500/30 overflow-x-hidden text-slate-100">
          ...
          <div className="relative z-10 mt-12 lg:mt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="lg:hidden group/btn flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:opacity-90 text-white px-6 py-3.5 rounded-full font-bold transition-all w-full shadow-lg shadow-blue-500/20 active:scale-95"
              >
                Mulai Login / Daftar
              ...
              >
                ...
                <div className="w-7 h-7 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 group-hover/btn:translate-y-1 transition-transform">
        ...
        <div ref={loginSectionRef} className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-8 lg:p-12 relative bg-slate-950 min-h-screen lg:min-h-0">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              <div className="hidden lg:flex w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-400 to-indigo-500 items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/20">
                <Wallet className="w-7 h-7 text-slate-900" />
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 bg-slate-900/50 border border-slate-800 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all text-sm"
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5 pl-1">
                  ...
                  {isLogin && <a href="#" className="text-[11px] font-medium text-blue-500 hover:text-blue-400">Lupa sandi?</a>}
                </div>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3.5 bg-slate-900/50 border border-slate-800 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all text-sm"
              ...
              {success && (
                <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs animate-in fade-in">
                  {success}
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 mt-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2 disabled:opacity-50 active:scale-[0.98] shadow-lg shadow-blue-500/20 text-sm"
              >
                {loading ? (
      ...
      <div ref={aboutSectionRef} className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-8 lg:p-24 relative overflow-hidden border-t border-slate-800">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-[500px] bg-blue-500/5 rounded-full blur-[100px] pointer-events-none" />

        <div className="text-center max-w-3xl mb-16 relative z-10">
          <h2 className="text-blue-400 font-bold tracking-widest uppercase text-sm mb-3">Ikhtisar Sistem</h2>
